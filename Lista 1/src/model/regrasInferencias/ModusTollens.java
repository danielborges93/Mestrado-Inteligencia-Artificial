 ...
 */
public class ModusTollens extends Regra {
	...
	for (String proposicao : proposicoes) {
		...
		// Salvar as entradas
		input[0] = proposicao;
		input[1] = "¬" + matcher.group(2);
		this.saida = "¬" + matcher.group(1);
	...
	if (encontrou[0] && encontrou[1]) {
	    System.out.println("Utilizando Modus Tollens com " + input[0] + " e " + input[1]);
